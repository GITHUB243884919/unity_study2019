...
{
    public class Sheet1Parse : LuaDaoBase <Sheet1>
    {
        public override void AddPrimaryIndex (Sheet1 model)
        {
        ...
        protected override Sheet1 ParseLuaTableData (string key, LuaTable tableData)
        {
