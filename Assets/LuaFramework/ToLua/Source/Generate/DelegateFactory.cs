...
public class DelegateFactory
{
	...
	class LuaMessageCenter_VOID_MESSAGE_Event : LuaDelegate
	{
		public LuaMessageCenter_VOID_MESSAGE_Event(LuaFunction func) : base(func) { }
		public LuaMessageCenter_VOID_MESSAGE_Event(LuaFunction func, LuaTable self) : base(func, self) { }

		public void Call(LuaMessageCenter.Message param0)
		{
			func.BeginPCall();
		...
		public void CallWithSelf(LuaMessageCenter.Message param0)
		{
			func.BeginPCall();
			func.Push(self);
			func.PushObject(param0);
	...
	public LuaMessageCenter.VOID_MESSAGE LuaMessageCenter_VOID_MESSAGE(LuaFunction func, LuaTable self, bool flag)
	{
		if (func == null)
		{
			LuaMessageCenter.VOID_MESSAGE fn = delegate(LuaMessageCenter.Message param0) { };
			return fn;
		}

		if(!flag)
		{
			LuaMessageCenter_VOID_MESSAGE_Event target = new LuaMessageCenter_VOID_MESSAGE_Event(func);
			LuaMessageCenter.VOID_MESSAGE d = target.Call;
			target.method = d.Method;
			return d;
		}
		else
		{
			LuaMessageCenter_VOID_MESSAGE_Event target = new LuaMessageCenter_VOID_MESSAGE_Event(func, self);
			LuaMessageCenter.VOID_MESSAGE d = target.CallWithSelf;
			target.method = d.Method;
			return d;
		}
	}

	bool Check_LuaMessageCenter_VOID_MESSAGE(IntPtr L, int pos)
	{
		return TypeChecker.CheckDelegateType(typeof(LuaMessageCenter.VOID_MESSAGE), L, pos);
	}

	void Push_LuaMessageCenter_VOID_MESSAGE(IntPtr L, LuaMessageCenter.VOID_MESSAGE o)
	{
		ToLua.Push(L, o);
	}

	class LuaMessageCenter_VOID_CB____Event : LuaDelegate
	{
		public LuaMessageCenter_VOID_CB____Event(LuaFunction func) : base(func) { }
		public LuaMessageCenter_VOID_CB____Event(LuaFunction func, LuaTable self) : base(func, self) { }
	...
	public LuaMessageCenter.VOID_CB___ LuaMessageCenter_VOID_CB___(LuaFunction func, LuaTable self, bool flag)
	{
		if (func == null)
		{
			LuaMessageCenter.VOID_CB___ fn = delegate() { };
			return fn;
		}

		if(!flag)
		{
			LuaMessageCenter_VOID_CB____Event target = new LuaMessageCenter_VOID_CB____Event(func);
			LuaMessageCenter.VOID_CB___ d = target.Call;
			target.method = d.Method;
			return d;
		}
		else
		{
			LuaMessageCenter_VOID_CB____Event target = new LuaMessageCenter_VOID_CB____Event(func, self);
			LuaMessageCenter.VOID_CB___ d = target.CallWithSelf;
			target.method = d.Method;
			return d;
		}
	}

	bool Check_LuaMessageCenter_VOID_CB___(IntPtr L, int pos)
	{
		return TypeChecker.CheckDelegateType(typeof(LuaMessageCenter.VOID_CB___), L, pos);
	}
